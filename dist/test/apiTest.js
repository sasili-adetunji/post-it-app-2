...
describe('Post message route', function () {
  it('should successfuly send message to groups', function (done) {
    _chai2.default.request(_server2.default).post('/message').send({ message: 'A test Message', groupId: '-KtfPZnYDzsnNyM3ubdM', priorityLevel: 'Normal', date: new Date(), author: 'Goodboy', status: 'Unread' }).end(function (err, res) {
